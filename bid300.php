      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="bid300.php"><i class="fa fa-circle-o"></i> 300 Level</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="info-box-content">
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <option></option>
                  ...
                  <option value="csc 313">CSC 313</option>
                  <option value="csc 314">CSC 314</option>
                  <option value="csc 315">CSC 315</option>
                  <option value="csc 317">CSC 317</option>
                  <option value="csc 318">CSC 318</option>
                  <option value="csc 319">CSC 319</option>
                </select>
                </div>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <select class="form-control">
                  <option>CIS 226</option>
                  <option>CSC 221</option>
                  <option>CSC 223</option>
                  <option>CSC 225</option>
                </select>
                </div>
                <div class="col-sm-3"><div style="padding-left: 50px;"><label class="radio-inline"><input form="bidd" type="radio" name="gg" value="Yes" >Yes</label>
                <label class="radio-inline"><input form="bidd" type="radio" name="gg" value="No">No</label></div></div>
                <div class="col-sm-3"><input form="bidd" class="form-control" type="Number" name="yrAs"></div>
                <div class="col-sm-3 "><input form="bidd" class="form-control" type="Number" name="yrLe"></div>
              </div>
            </div>
            <div class="row pad">
              <div class="col-sm-12">
          ...
          <div class="row pad">
            <form id="fuzzy" method="post" action="bid300.php">
...
//             $avgScore21 = ($tscore21 + $Ascore21 + $Lscore21)/3;
//             $avgScore22 = ($tscore22 + $Ascore22 + $Lscore22)/3;
//             $avgScore23 = ($tscore23 + $Ascore23 + $Lscore23)/3;

             $qw = "INSERT into bidtb VALUES ('1','$val','300','first','$bid11','$tscore11','$Ascore11','$Lscore11','$pScore','$avgScore11')";
             $qww = "INSERT into bidtb VALUES ('2','$val','300','first','$bid12','$tscore12','$Ascore12','$Lscore12','$pScore','$avgScore12')";
             $qwww = "INSERT into bidtb VALUES ('3','$val','300','first','$bid13','$tscore13','$Ascore13','$Lscore13','$pScore','$avgScore13')";

             // $qw1 = "INSERT into bidtb VALUES ('1','$val','100','second','$bid21','$tscore21','$Ascore21','$Lscore21','$pScore','$avgScore21')";
             // $qww1 = "INSERT into bidtb VALUES ('2','$val','100','second','$bid22','$tscore22','$Ascore22','$Lscore22','$pScore','$avgScore22')";
             // $qwww1 = "INSERT into bidtb VALUES ('3','$val','100','second','$bid23','$tscore23','$Ascore23','$Lscore23','$pScore','$avgScore23')";
