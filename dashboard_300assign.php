      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="dashboard_300assign.php"><i class="fa fa-circle-o"></i> 300 Level</a></li>
          ...
          <fieldset>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <form method="post" action="dashboard_300assign.php">
