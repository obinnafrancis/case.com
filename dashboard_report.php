  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="info-box-content">
          ...
          <fieldset>
            <legend>State Your Challenge</legend>
            <div class="row pad">
              <div class="col-sm-12">
                <form method="post" action="dashboard_report.php">
                  <div class="form-group">
                    <label for="sub">Subject:</label>
                    <input type="text" name="subject" placeholder="Enter the reason for the message" class="form-control" id="sub">
                  </div>
                  <div class="form-group">
                    <label for="msg">Message:</label>
                    <textarea class="form-control" name="message" rows="10" id="msg" placeholder="Type your message"></textarea> 
                  </div>
                                    <input type="submit" name="submit" class="form-control btn btn-block btn-primary" value="SendMail">
