      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="dashboard_100assign.php"><i class="fa fa-circle-o"></i> 100 Level</a></li>
          ...
          <fieldset>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <form method="post" action="dashboard_100assign.php">
              ...
              if (isset($_POST['finder'])){
                ...
                echo "<table class='table table-bordered table-hover dataTable'>
                        ...
                        while ($row = mysqli_fetch_array($mydata)) {
                          ...
                          //echo "<td> <input type ='submit' name= 'assign' class = 'btn btn-success' value = 'assign'> </td>";

                          echo "</tr>";

                        ?>
                        
                        <select hidden name ="selection" >
                ...
                <?php
                  if (isset($_POST['Assign'])){
                      ...
                      //$runn = "INSERT INTO allocation values ('$pp')";
                      $runn = "insert into allocation values ('$pp','$cos')";
                      //$poi = "INSERT INTO allocation values ('1','2')";
                      //$qwr = mysqli_query($conn,$runn);
                      $qwr = mysql_query($runn);
                      echo "$qwr";
                      if ($qwr){
