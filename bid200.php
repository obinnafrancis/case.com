      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="bid200.php"><i class="fa fa-circle-o"></i> 200 Level</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="info-box-content">
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <option></option>
                  ...
                  <option value="csc 213">CSC 213</option>
                  <option value="csc 214">CSC 214</option>
                  <option value="csc 215">CSC 215</option>
                  <option value="csc 216">CSC 216</option>
                </select>
                </div>
          ...
          <br>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <option></option>
                  <option value="csc 226">CIS 226</option>
                  <option value="csc 221">CSC 221</option>
                  <option value="csc 223">CSC 223</option>
                  <option value="csc 225">CSC 225</option>
                </select>
                </div>
          ...
          <div class="row pad">
            <form id="fuzzy" method="post" action="bid200.php">
...
#
            ...
            $avgScore23 = ($tscore23 + $Ascore23 + $Lscore23 + $pScore)/4;
             ...
             $qw = "INSERT into bidtb VALUES ('1','$val','200','first','$bid11','$tscore11','$Ascore11','$Lscore11','$pScore','$avgScore11')";
             $qww = "INSERT into bidtb VALUES ('2','$val','200','first','$bid12','$tscore12','$Ascore12','$Lscore12','$pScore','$avgScore12')";
             $qwww = "INSERT into bidtb VALUES ('3','$val','200','first','$bid13','$tscore13','$Ascore13','$Lscore13','$pScore','$avgScore13')";

             $qw1 = "INSERT into bidtb VALUES ('1','$val','200','second','$bid21','$tscore21','$Ascore21','$Lscore21','$pScore','$avgScore21')";
             $qww1 = "INSERT into bidtb VALUES ('2','$val','200','second','$bid22','$tscore22','$Ascore22','$Lscore22','$pScore','$avgScore22')";
             $qwww1 = "INSERT into bidtb VALUES ('3','$val','200','second','$bid23','$tscore23','$Ascore23','$Lscore23','$pScore','$avgScore23')";
