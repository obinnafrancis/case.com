      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="bid100.php"><i class="fa fa-circle-o"></i> 100 Level</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="info-box-content">
          ...
          <fieldset>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <div class="col-sm-3"><div style="padding-left: 50px;"><label class="radio-inline"><input type="radio" form ="fuzzy" name="gg1a" value="Yes" >Yes</label>
                <label class="radio-inline"><input type="radio" name="gg1a" form ="fuzzy" value="No">No</label></div></div>
                <div class="col-sm-3"><input class="form-control" form ="fuzzy" type="Number" name="yrAs1a"></div>
                <div class="col-sm-3 "><input class="form-control" type="Number" form ="fuzzy" name="yrLe1a"></div>
              </div>
            </div>
          ...
          <div class="row pad">
            <form id="fuzzy" method="post" action="bid100.php">
...
#
            ...
            // $avgScore12 = ($tscore12 + $Ascore12 + $Lscore12)/3;
            // $avgScore13 = ($tscore13 + $Ascore13 + $Lscore13)/3;
############################################################################
            if ($tt21 == 'Yes')
            {
              $tscore21 = 0.8;
...
#
            ...
            // $avgScore23 = ($tscore23 + $Ascore23 + $Lscore23)/3;
             ...
             $qw = "INSERT into bidtb VALUES ('1','$val','100','first','$bid11','$tscore11','$Ascore11','$Lscore11','$pScore','$avgScore11')";
             // $qww = "INSERT into bidtb VALUES ('2','$val','100','first','$bid12','$tscore12','$Ascore12','$Lscore12','$pScore','$avgScore12')";
             // $qwww = "INSERT into bidtb VALUES ('3','$val','100','first','$bid13','$tscore13','$Ascore13','$Lscore13','$pScore','$avgScore13')";
