...
<?php
          ...
          $qwer2 = "select * from teachprofile where username = '$val'";
          $qwer_run = mysqli_query($conn,$qwer);
          $qwer_run1 = mysqli_query($conn,$qwer2);
          ...
          if(mysqli_num_rows($qwer_run1)>0)
          {
            // echo "<h2><center>Data available!</center></h2>";
            while ($row = mysqli_fetch_assoc($qwer_run1)) 
            {
          ...
          <fieldset>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <div class="col-sm-10 "><b><?php echo $satus?></b></div>
              </div>
            </div>
            <div class="row pad">
              <div class="col-sm-12">
            ...
            <div class="row pad">
              <div class="col-sm-12">
                ...
                <div class="col-sm-10">lecturer</div>
              </div>
            </div>
            <div class="row pad">
              <div class="col-sm-12">
