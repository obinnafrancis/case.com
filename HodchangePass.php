      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="HodchangePass.php"><i class="fa fa-circle-o"></i> Change Password</a></li>
          </ul>
        </li>
        <li class="treeview">
    ...
    <section class="content">
      ...
      <div class="info-box-content">
          ...
          <fieldset>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                <form method="post" action="HodchangePass.php">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Password" name="pwd" placeholder="Confirm Password" class="form-control" id="sub1">
                  </div>
                  <input type="submit" name="submit" class="form-control btn btn-block btn-primary" value="Change Password">
