      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="lecPassword.php"><i class="fa fa-circle-o"></i> Change Password</a></li>
          </ul>
        </li>
        <li class="treeview">
    ...
    <section class="content">
      ...
      <div class="info-box-content">
          ...
          <fieldset>
            ...
            <div class="row pad">
              <div class="col-sm-12">
                <form method="post" action="lecPassword.php">
                  <div class="form-group">
                    <label for="sub">Enter New Password:</label>
                    <input type="Password" name="pwd" placeholder="Enter Password" class="form-control" id="sub">
                  </div>
                  <div class="form-group">
                    <label for="sub1">Enter New Password Again:</label>
                    <input type="Password" name="cpwd" placeholder="Confirm Password" class="form-control" id="sub1">
                  </div>
                  <input type="submit" name="pasw" class="form-control btn btn-block btn-primary" value="Change Password">
                ...
                <?php
                    if (isset($_POST['pasw'])){
                      ...
                      if ($pa==$cpa){
                        $qwe = "update register set password = '$pa' where username = '$val'";
